  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="flex justify-center pt-16 items-center flex-col">
        ...
        <p className="text-[#57544F] font-normal text-base font-jakarta px-5 text-center pt-5">
          Bir yardım sever olarak bize destek olduğun için çok teşekkür ederiz. 
          <p className="text-[#57544F] font-normal text-base font-jakarta text-center pt-5">En kısa sürede sizinle iletişime geçeceğiz.</p>
        </p>
